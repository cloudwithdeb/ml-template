...
--member="principalSet://iam.googleapis.com/projects/$WORKLOAD_IDENTITY_POOLS_PROJECT_ID/locations/$LOCATION/workloadIdentityPools/$WORKLOAD_IDENTITY_POOLS/*"